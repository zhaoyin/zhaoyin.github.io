...
![包依赖关系](http://oqcey66z7.bkt.clouddn.com/public/images/orderpackage.png "包依赖关系")
例如上图销售订单包依赖系统用户包，基础单据包和商品档案包。包的依赖关系在xml中不体现，而是通过更细粒度的类中的关系来体现。
![类之间关系](http://oqcey66z7.bkt.clouddn.com/public/images/ordermeta.png "类之间关系")
...
![元数据结构](http://oqcey66z7.bkt.clouddn.com/public/images/metastruct.png "元数据结构")
...
![组合关系描述](http://oqcey66z7.bkt.clouddn.com/public/images/association.png "组合关系描述")
如上，订单和订单子表是一对多的关系
